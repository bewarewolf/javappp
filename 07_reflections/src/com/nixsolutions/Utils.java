...
public class Utils {
  ...
  public static Object getPublicValueGoogleReflections(MyBean myBean, String fldName) 
  ...
  private static Object getValueIfAnnotated(MyBean bean, Field fld) 
      throws IllegalAccessException {
    if (fld.isAnnotationPresent(Public.class)) {
      return fld.get(bean);
    } else {
      throw new IllegalAccessException("Field " + fld.getName() + " is not annotated");
    }
  }
}
