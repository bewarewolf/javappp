Вариант 2. Написать тест в терминах BDD на класс StringBuilder
...
команда шаг вперед изменяет координаты в соответствии с направлением и записывает их в поток. 
Реализовать класс Program, выполняющий цепочку команд над роботом, заданным кодом (lffrflfrrfff) 
 и генерирующий файл с маршрутом робота.
 
1. Протестировать что Program и Robot работают правильно, использовать это (1 тест):
  @Rule
  public TemporaryFolder folder = new TemporaryFolder();
  
2. Протестировать что Program и Robot работает правильно, используя mocks, избегая создания файлов (2 теста)
