...
INSERT INTO person (first_name, middle_name, last_name, birthday, date_start, person_type_id, person_status_id, login, password) VALUES ('Averill', 'Humphrey', 'Samuelson', TO_DATE('25-SEP-1916', 'DD-MON-YYYY'), TO_DATE('25-JUN-2006', 'DD-MON-YYYY'), 1, 1, 'root', 'root');

INSERT INTO person (first_name, middle_name, last_name, birthday, date_start, person_type_id, person_status_id, login, password) VALUES ('Aden', 'Giffard', 'Lyon', TO_DATE('20-MAR-1975', 'DD-MON-YYYY'), TO_DATE('15-AUG-2012', 'DD-MON-YYYY'), 2, 1, 'aden', 'aden');

INSERT INTO person (first_name, middle_name, last_name, birthday, date_start, person_type_id, person_status_id, login, password) VALUES ('Matt', 'Sullivan', 'Hochberg', TO_DATE('13-FEB-1963', 'DD-MON-YYYY'), TO_DATE('15-AUG-2012', 'DD-MON-YYYY'), 3, 1, 'matt', 'matt');

INSERT INTO person (first_name, middle_name, last_name, birthday, date_start, person_type_id, person_status_id, login, password) VALUES ('Jarod', NULL, 'Fry', TO_DATE('15-MAR-1993', 'DD-MON-YYYY'), TO_DATE('15-AUG-2015', 'DD-MON-YYYY'), 3, 1, 'jarod', 'jarod');

INSERT INTO person (first_name, middle_name, last_name, birthday, date_start, person_type_id, person_status_id, login, password) VALUES ('Yvo', 'Vern', 'Barnet', TO_DATE('1-JUN-1990', 'DD-MON-YYYY'), TO_DATE('13-AUG-2015', 'DD-MON-YYYY'), 3, 1, 'yvo', 'yvo');

INSERT INTO person (first_name, middle_name, last_name, birthday, date_start, person_type_id, person_status_id, login, password) VALUES ('Mark', 'Nathan', 'Konstantinov', TO_DATE('12-JUN-1992', 'DD-MON-YYYY'), TO_DATE('25-DEC-2015', 'DD-MON-YYYY'), 3, 2, 'mark', 'mark');

INSERT INTO person (first_name, middle_name, last_name, birthday, date_start, person_type_id, person_status_id, login, password) VALUES ('Dana', 'Osmond', 'Savage', TO_DATE('14-JUN-1992', 'DD-MON-YYYY'), TO_DATE('20-DEC-2015', 'DD-MON-YYYY'), 3, 3, 'dana', 'dana');

INSERT INTO person (first_name, middle_name, last_name, birthday, date_start, person_type_id, person_status_id, login, password) VALUES ('Darnell', 'Tim', 'Sandford', TO_DATE('14-JUN-1992', 'DD-MON-YYYY'), TO_DATE('20-DEC-2015', 'DD-MON-YYYY'), 3, 4, 'darnell', 'darnell');
