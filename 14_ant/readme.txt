Создать build.xml файл который позволяет с помощью Ant откомпилировать 
и упаковать в jar файл проект.
...
2. Должны быть реализованы следующие targets
   ...
   test - запуск тестов
3. Properties должны читаться из файла project.properties  
   и если они там отсутствуют то должны браться их build.xml.
