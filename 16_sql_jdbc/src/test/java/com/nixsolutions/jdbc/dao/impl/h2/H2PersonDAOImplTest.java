...
public class H2PersonDAOImplTest extends BaseTest {
  ...
  public H2PersonDAOImplTest(String name) throws Exception {
    ...
    insertBean = new Person("Jarod", null, "Fry", LocalDate.parse("1993-03-15"), LocalDate.parse("2015-08-15"), 2, 1);
    updateBean = new Person(3, "Mattew", null, "upd", LocalDate.parse("1963-02-13"), LocalDate.parse("2012-08-15"), 2,
	1);
    deleteId = 3;
  }
  ...
  public void testShouldGetPersonById() throws Exception {
	...
	pers.getPersonStatusId(), expectedTable.getValue(0, "person_status_id"));
    Assert.assertEquals("Mismatch in person_type_id", 
	pers.getPersonTypeId(), expectedTable.getValue(0, "person_type_id"));
  }
